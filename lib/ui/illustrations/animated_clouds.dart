...
// import 'package:laatte/utils/context_utils.dart';
...
//     return switch (type) {
//       WonderType.chichenItza => 3,
//       WonderType.christRedeemer => 2,
...
//     Size size = ContextUtils.getSize(context) ?? Size(600, 400);
...
//         child: Opacity(
//           opacity: AlwaysStoppedAnimation(.9 * opacity).value,
//           child: SvgPicture.asset(
//             // 'assets/img/cloud-white.png',
//             AssetsName.svgPlanet,
//             // height: size * scale,
