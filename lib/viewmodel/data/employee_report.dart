...
class EmployeeReportSplash extends WonderData {
  EmployeeReportSplash()
      : super(
          // searchData: _searchData, // included as a part from ./search/
          searchSuggestions: ['e'], // included as a part from ./search/
          type: WonderType.employeeReports,
          title: 'Insightful Employee Reports',
          subTitle:
              'Generate detailed reports to gain valuable insights into employee performance and productivity.',
          regionTitle: 'd',
          videoId: 'do1Go22Wu8o',
          startYr: -700,
          endYr: 1644,
